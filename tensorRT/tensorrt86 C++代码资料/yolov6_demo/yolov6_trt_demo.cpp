...
YOLOv6TRTDetector::~YOLOv6TRTDetector() {
	// 同步结束，释放资源
...
void YOLOv6TRTDetector::initConfig(std::string enginefile, float conf_thresholod, float score_thresholod) {
	...
	int output_index = engine->getBindingIndex("outputs");
...
void YOLOv6TRTDetector::detect(cv::Mat &frame, std::vector<DetectResult> &results) {
